...
\newabbreviationshort{HTBLA}{Höhere Technische Bundeslehranstalt}
\newglossaryentryshort{Schule}{Bildungseinrichtung}
...
\begin{document}
    ...
    Neben diesem Satz finden Sie das Logo der \gls{HTBLA} Grieskirchen.
    Beispiel-Zitat Eins.\cite{roman_bittersuse_1986}
    Beispiel-Zitat Zwei.\cite{pc_hardwarebuch}
    Eine \gls{HTBLA} ist eine \gls{Schule}.
